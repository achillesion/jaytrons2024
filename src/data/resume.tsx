...
export const DATA = {
  ...
  summary:
    ...
    "At the end of 2022, I quit my job as a Senior Full Stack Developer to go full-time into Freelancing on Upwork and working on Silicon Valley scale projects. My ability to communicate and collaborate effectively with clients and team members sets me apart from other designers and developers.",
