...
export const DATA = {
  ...
  projects: [
      {
      title: "Good Night Planes",
      href: "https://www.upwork.com/freelancers/ahmadbashir1?p=2071072355905994752",
      dates: "Aug 2024 - Apr 2025",
      active: true,
      description:
        "Built a marketplace for 10K–20K concurrent users. Expanded to 5 phases, totaling ~$21K. Fixed a critical booking-flow flaw. Managed end-to-end delivery (design → Azure deployment).",
      technologies: [
         "Figma",
        "Next.js",
        "Typescript",
      ...
      links: [
        {
          type: "SaaS Mobile & Web App",
          href: "https://www.upwork.com/freelancers/ahmadbashir1?p=2071072355905994752",
          icon: <Icons.globe className="size-3" />,
        },
      ],
      image: "https://i.ibb.co/w33RWGG/i-Pad-mini-8-3-12.png",
      video: "",
    },

     {
      ...
      active: true,
      description:
        "Homepage trial → 10-month contract, 10 → 30 hrs/week. Designed a unified design system across key product flows. Delivered full mobile app UI with web parity. Established a design QA process to prevent UI drift. Ended with 5-star client feedback and future opportunities.",
      technologies: [
         "Figma", "Google Analytics", "Next.js", "Typescript",  "TailwindCSS", "Stripe"
      ],
      links: [
        {
          type: "Ecomerce Website",
          href: "https://www.upwork.com/freelancers/ahmadbashir1?p=2071072355905994752",
          icon: <Icons.globe className="size-3" />,
        },
      ],
      image: "https://i.ibb.co/21gNLkQZ/i-Pad-mini-8-3-13.png",
      video: "",
    },


     {
      title: "Fitness Mobile & Web App",
      href: "http://apps.apple.com/ie/app/pod1um-athlete/id1562663063",
      dates: "Aug 2024 - Apr 2025",
      active: true,
      description:
        "KPI'S +28% engagement, 4.8★ rating, 100K+ users, 50+ screens, 30% faster task completion. I Led the Pod1um Coach app redesign with a cross-functional team. Built a global design system across web and mobile. Improved UX consistency across all athlete touchpoints. Enhanced usability and user engagement through streamlined flows.",
      technologies: [
         "Figma", "React Native", "Next.js", "Typescript",  "TailwindCSS", "Stripe"
      ],
      links: [
        {
          type: "App Store",
      ...
      image: "https://i.ibb.co/QvVvwvhR/i-Pad-mini-8-3-11.png",
      video: "",
    },
